...
namespace LFbrokersV2.Controllers
{
    public class ProductoesController : Controller
    {
        ...
        public ProductoesController(LFbrokersContext context)
        {
            _context = context;
        }
        ...
        {
            var lFbrokersContext = _context.Producto.Include(p => p.RamoNavigation);
        ...
        {
            ViewData["Ramo"] = new SelectList(_context.Ramo, "Id", "Ramo1");
            return View();
        }
